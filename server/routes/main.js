...
function appRoutes()
{
  ...
  // router.post('/collection/:id/asset/:asset/', map.collectionAddAsset)
  // router.get('/collection/:id/asset/:asset/', map.collectionAssets)
  // router.put('/collection/:id/asset/:asset/', map.collectionEditAssets)
  // router.delete('/collection/:id/asset/:asset/', map.collectionRemoveAsset)
  // user
